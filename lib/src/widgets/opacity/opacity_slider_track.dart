...
class OpacitySliderTrack extends SliderTrackShape {
  ...
  ///
  /// The [ui.Rect] is centered both horizontally and vertically within the slider
  /// bounds.
  @override
  ...
  void paint(
    ...
    assert(sliderTheme.disabledActiveTrackColor != null, 'disabledActiveTrackColor cannot be null.');
    assert(sliderTheme.disabledInactiveTrackColor != null, 'disabledInactiveTrackColor cannot be null.');
    assert(sliderTheme.activeTrackColor != null, 'activeTrackColor cannot be null.');
    assert(sliderTheme.inactiveTrackColor != null, 'inactiveTrackColor cannot be null.');
