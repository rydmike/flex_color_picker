...
void main() {
  ...
  group('CPCPB1: WITH ColorPickerCopyPasteBehavior ', () {
    ...
    const ColorPickerCopyPasteBehavior m3 = ColorPickerCopyPasteBehavior(copyTooltip: 'COPY ME');

    test('CPCPB1.1a: GIVEN same ColorPickerCopyPasteBehavior objects '
        'EXPECT them to have equality', () {
      expect(m1, equals(m1));
    });
    test('CPCPB1.1b: GIVEN same ColorPickerCopyPasteBehavior objects '
        'EXPECT them to have identity', () {
      expect(identical(m1, m1), true);
    });
    test('CPCPB1.2a: GIVEN two equal ColorPickerCopyPasteBehavior objects '
        'EXPECT them to have equality', () {
      expect(m1, equals(m2));
    });
    test('CPCPB1.2a: GIVEN two equal ColorPickerCopyPasteBehavior objects '
    ...
    test('CPCPB1.3: GIVEN two equal ColorPickerCopyPasteBehavior objects '
        'EXPECT them to have equality with operator', () {
      expect(m1 == m2, true);
    });
    test('CPCPB1.4: GIVEN none equal ColorPickerCopyPasteBehavior objects '
        'EXPECT them to be unequal', () {
      expect(m1, isNot(m3));
    });
    test('CPCPB1.5: GIVEN none equal ColorPickerCopyPasteBehavior objects '
    ...
    const ColorPickerCopyPasteBehavior m4 = ColorPickerCopyPasteBehavior(
      ...
      menuIconThemeData: IconThemeData(opacity: 50, size: 30, color: Colors.black),
    ...
    test('CPCPB2.1: Test toString implemented via debugFillProperties '
    ...
    test('CPCPB2.2: Test toStringShort implemented via debugFillProperties '
        'EXPECT exact short printout.', () {
      expect(m4.toStringShort(), equalsIgnoringHashCodes('ColorPickerCopyPasteBehavior#00000'));
    });
    ...
    test('CPCPB3.1: GIVEN a ColorPickerCopyPasteBehavior object EXPECT it to be '
      ...
      expect(
        m1.copyWith(
          ...
          secondaryOnDesktopLongOnDeviceAndWeb: true,
          editFieldCopyButton: false,
          menuIconThemeData: const IconThemeData(opacity: 50, size: 30, color: Colors.black),
    ...
    test('CPCPB3.2: GIVEN a ColorPickerCopyPasteBehavior object EXPECT it to '
        'be unchanged after an empty copyWith.', () {
      expect(m4, equals(m4.copyWith()));
    });

    test('CPCPB3.3: GIVEN two identical but different '
    ...
    test('CPCPB3.4: GIVEN a ColorPickerCopyPasteBehavior object EXPECT it to be '
    ...
    test('CPCPB3.5: GIVEN two identical but different '
        'ColorPickerCopyPasteBehavior '
        'object EXPECT them to '
    ...
    test('CPCPB3.6: GIVEN a ColorPickerCopyPasteBehavior object EXPECT it to be '
    ...
    test('CPCPB3.7: GIVEN a ColorPickerCopyPasteBehavior object EXPECT it to be '
        'equal to another object with same copyWith values.', () {
      expect(
        m2.copyWith(
          ctrlC: null,
